/**
 * SquishClient -- main SDK entry point for interacting with the squish memory
 * system.  Extracted from index.ts for maintainability.
 *
 * @module
 */
...
import { SquishError, StorageError } from './errors.js';
